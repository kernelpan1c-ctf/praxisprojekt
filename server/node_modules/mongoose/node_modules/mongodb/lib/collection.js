 ...
 *   var col = studdb.collection('createIndexExample1');
...
Collection.prototype.find = function() {
  ...
  // // If we have overridden slaveOk otherwise use the default studdb setting
  ...
  // Add studdb object to the new options
...
/**
 * Count number of matching documents in the studdb to a query.
 * @method
...
var mapReduce = function(self, map, reduce, options, callback) {
  ...
  self.s.db.command(mapCommandHash, {readPreference:options.readPreference}, function (err, result) {
    ...
    // If we have an object it's a different studdb
