 ...
 *   var gridStore = new GridStore(studdb, null, "w");
 *   gridStore.open(function(err, gridStore) {
 *     gridStore.write("hello world!", function(err, gridStore) {
 *       gridStore.close(function(err, result) {
 *
 *         // Let's read the file using object Id
 *         GridStore.read(studdb, result._id, function(err, data) {
 ...
 *
 * (studdb, name, callback)
 * (studdb, name, length, callback)
 * (studdb, name, length, offset, callback)
 * (studdb, name, length, offset, options, callback)
 *
 * @method
 * @static
 * @param {Db} db the database to query.
