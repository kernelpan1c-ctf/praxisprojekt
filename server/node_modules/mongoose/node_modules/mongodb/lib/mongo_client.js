...
function MongoClient() {
   ...
   * @param {object} [options.studdb=null] A hash of options to set on the studdb object, see **Db constructor**
...
var connect = function(url, options, callback) {
  ...
  // Merge in any options for studdb in options object
  if(dbOptions) {
  ...
  // If we have no studdb setting for the native parser try to set the c++ one first
...
var _finishConnecting = function(serverConfig, object, options, callback) {
  // If we have a readPreference passed in by the studdb options
  ...
  db.open(function(err, db){
    ...
    if(err == null && object.auth){
      // What studdb to authenticate against
