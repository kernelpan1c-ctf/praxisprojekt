 ...
 *     })
 *
 *     var User = studdb.model('User', UserSchema)
 *
 ...
 *     })
 *
 *     var Virus = studdb.model('Virus', VirusSchema);
 ...
 *     });
 *
 *     var Account = studdb.model('Account', AccountSchema);
 *
 ...
 *
 * If validation fails during `pre('save')` and no callback was passed to receive the error, an `error` event will be emitted on your Models associated studdb [connection](#connection_Connection), passing the validation error object along.
 *
 ...
 * ####Example:
 *
 *     T = studdb.model('T', new Schema({ x: { type: String, select: true }}));
...
SchemaType._isRef = function (self, value, doc, init) {
  ...
  if (ref) {
    ...
    if (!Buffer.isBuffer(value) &&  // buffers are objects too
        'Binary' != value._bsontype // raw binary value from the studdb
