 ...
 *     var Product = studdb.model('Product', schema);
 *
 *     studdb.on('error', handleError);
 *
...
function checkDivergentArray (doc, path, array) {
  ...
  // of the array in the studdb which is not guaranteed to be the
...
/**
 * Removes this document from the studdb.
 *
 * ####Example:
...
/**
 * Shortcut for creating a new Document that is automatically saved to the studdb if valid.
 *
 * ####Example:
 *
