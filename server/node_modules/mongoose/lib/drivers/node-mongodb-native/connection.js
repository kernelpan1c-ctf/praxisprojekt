 ...
 *
 * Returns a new connection object, with the new studdb.
 *
...
NativeConnection.prototype.useDb = function (name) {
  ...
  // First, when we create another studdb object, we are not guaranteed to have a
  // studdb object to work with. So, in the case where we have a studdb object and it
  // is connected, we can just proceed with setting everything up. However, if
  // we do not have a studdb or the state is not connected, then we need to wait on
  // the 'open' event of the connection before doing the rest of the setup
  // the 'connected' event is the first time we'll have access to the studdb object
...
/*!
 * Validates the driver studdb options.
 *
 * @param {Object} o
 */
