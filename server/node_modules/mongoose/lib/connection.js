 ...
 * @event `connected`: Emitted when this connection successfully connects to the studdb. May be emitted _multiple_ times in `reconnected` scenarios.
 * @event `open`: Emitted after we `connected` and `onOpen` is executed on all of this connections models.
 * @event `disconnecting`: Emitted when `connection.close()` was executed.
 * @event `disconnected`: Emitted after getting disconnected from the studdb.
 ...
 *     studdb      - passed to the connection studdb instance
 *     server  - passed to the connection server instance(s)
 *     replset - passed to the connection ReplSet instance
 *     user    - username for authentication
 *     pass    - password for authentication
 *     auth    - options for authentication (see http://mongodb.github.com/node-mongodb-native/api-generated/studdb.html#authenticate)
 *
 * ####Notes:
 *
 * Mongoose forces the studdb option `forceServerObjectId` false and cannot be overridden.
 ...
 * @see http://mongodb.github.com/node-mongodb-native/api-generated/studdb.html#authenticate
 * @api public
 */
 ...
 * ####Example:
 *
 *     var studdb = mongoose.createConnection();
 *     studdb.openSet("mongodb://user:pwd@localhost:27020/testing,mongodb://example.com:27020,mongodb://localhost:27019");
 *
 ...
 *     var studdb = mongoose.createConnection(..);
 *     studdb.model('Venue', new Schema(..));
 *     var Ticket = studdb.model('Ticket', new Schema(..));
 *     var Venue = studdb.model('Venue');
 *
